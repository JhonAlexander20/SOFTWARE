    ...
    <div class="max-w-7xl mx-auto py-12">
        <div class="bg-white shadow-lg sm:rounded-lg p-10">
            <h1 class="text-4xl font-bold text-gray-800 mb-8 flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-gray-700 mr-3" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
                ...
                <div class="bg-gray-100 p-8 rounded-lg shadow-md">
                    <h2 class="text-2xl font-semibold text-gray-900 mb-6">Datos del Postulante</h2>
                    <div class="space-y-4 text-lg">
                        <p class="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-gray-600 mr-3" viewBox="0 0 24 24" fill="currentColor">
                ...
                <div class="bg-gray-100 p-8 rounded-lg shadow-md">
                    <h2 class="text-2xl font-semibold text-gray-900 mb-6">Detalles de la Oferta</h2>
                    <div class="space-y-4 text-lg">
                        <p><strong>Título:</strong> {{ $postulacion->oferta->titulo }}</p>
                        <p><strong>Descripción:</strong> {{ $postulacion->oferta->descripcion }}</p>
                        <p><strong>Salario:</strong> {{ $postulacion->oferta->salario }}</p>
                        <p><strong>Ubicación:</strong> {{ $postulacion->oferta->ubicacion }}</p>
                        <p><strong>Fecha de vencimiento:</strong> {{ $postulacion->oferta->fecha_vencimiento }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-10 flex space-x-4">
                <form action="{{ route('postulaciones.actualizar-estado', $postulacion->id) }}" method="POST">
                    ...
                    <button type="submit" class="bg-green-500 hover:bg-green-600 text-white py-3 px-6 rounded-lg flex items-center transition-all duration-300 ease-in-out">
                ...
                <a href="{{ route('gestionar-postulaciones') }}" class="bg-blue-500 hover:bg-blue-600 text-white py-3 px-6 rounded-lg flex items-center transition-all duration-300 ease-in-out">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-2" viewBox="0 0 24 24" fill="currentColor">
                        <path d="M19 3H5c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h6v2H8v2h8v-2h-3v-2h6c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 14H5V5h14v12z"/>
                    </svg>
                    Regresar
                </a>
            </div>
